...
| `RWKV7ForCausalLM` | RWKV7 | `RWKV/RWKV7-Goose-World2.8-0.1B-HF`, etc. | | ✅︎ |
| `RWKV7HybridForCausalLM` | RWKV7 with configured full-attention layers | Hybrid RWKV7 checkpoints | | ✅︎ |
